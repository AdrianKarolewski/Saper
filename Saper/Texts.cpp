...
#include <string.h>
#include <iostream>
Texts::Texts(sf::Font &font, const char* st_come, sf::Color color, int size_s_come, sf::Vector2f vector_come_text_pos, sf::Vector2f vector_come_box, sf::Vector2f vector_come_box_position)
{
	std::cout << "Tworze obiekt";
